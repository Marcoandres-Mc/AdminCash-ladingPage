...
const Blanco = () => {
  return (
    <div className='flex justify-center align-middle hexagonB'>
        <svg className='w-[30px] h-[30px]' xmlns="http://www.w3.org/2000/svg" version="1.0" width="42.0pt" height="42.0pt" viewBox="0 0 42.0 42.0" preserveAspectRatio="xMidYMid meet">
        <g transform="translate(0.000000,42.000000) scale(0.100000,-0.100000)" fill="#ffffff" stroke="none">
